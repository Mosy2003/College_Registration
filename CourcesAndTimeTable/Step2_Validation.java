...
public class Step2_Validation extends JFrame {
    ...
    private final JButton assignBtn = new JButton("Assign & Continue");
    private final JLabel status = new JLabel(" ");

    public Step2_Validation() {
        super("Step 2 — Validation");
    ...
    private void onAssign(){
        ...
        info("OK. Inputs are valid.");
        JOptionPane.showMessageDialog(this, "Valid selection captured.");
    }
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(() -> new Step2_Validation().setVisible(true));
    }
}
