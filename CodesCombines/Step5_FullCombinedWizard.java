...
public class Step5_FullCombinedWizard extends JFrame {
    // ===== Domain + Store =====
    ...
    public Step5_FullCombinedWizard(){
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(() -> new Step5_FullCombinedWizard().setVisible(true));
    }
}
